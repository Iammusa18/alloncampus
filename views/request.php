            ...
            <table class="table table-bordered table-striped table-hover">
                <thead>
                    ...
                    <th>Title</th>
                      <?php 
                if(isset( $_SESSION["type"])){
                                if( $_SESSION["type"]=="admin"){//yes this is for request to see if admin, if so, add the buttons/tabs.
                                    ?>
                                    <th>Actions</th>
                                  <?php 
                              }
...
<script>
    ...
    $(document).ready(function () {
        $('#imageForm').on('submit', function (e) { // new image upload request
            ...
            $.ajax({//uploading or updating image ..
